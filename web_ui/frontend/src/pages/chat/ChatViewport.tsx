...
import { WorkspaceFilesDrawer } from '@/components/drawer/WorkspaceFilesDrawer';
			...
			<main className="flex size-full">
				<div className="flex flex-col flex-1 min-h-0">
					...
					<div className="flex items-center gap-2 px-4 py-2 border-b bg-background/95 backdrop-blur-sm">
						<div id="tour-llm-select" className="flex items-center gap-1">
							<LlmSelect
								value={selectedModel}
					...
					<div className="flex flex-1 min-h-0 overflow-hidden">
						<TaskPanel
							className="shrink-0 w-64 border-r"
							tasksContext={tasksContext}
							agentId={agentId}
							sessionId={sessionId}
							onTasksChanged={refetchSessions}
						/>
