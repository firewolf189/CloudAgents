	...
	(
		...
		return (
			<div
				id="tour-chat-input"
				className={cn(
					'flex flex-col gap-2 rounded-2xl border bg-background p-3 shadow-sm ring-1 ring-border/50 transition-shadow focus-within:shadow-md focus-within:ring-border',
					className,
				)}
