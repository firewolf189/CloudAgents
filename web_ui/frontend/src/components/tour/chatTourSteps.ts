...
export const EMPLOYEE_TOUR_NAME = 'employee-onboarding';
...
export const buildEmployeeTour = (t: TFunction): Tour => ({
	tour: EMPLOYEE_TOUR_NAME,
	steps: [
		{
			icon: null,
			title: t('tour.selectAgent.title'),
			content: t('tour.selectAgent.content'),
			selector: '#tour-select-agent',
			side: 'right',
			showControls: false,
			pointerPadding: 6,
			pointerRadius: 6,
